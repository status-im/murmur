...
class Provider {
  ...
  shh_unsubscribe(_payload, _cb) {
    throw new Error("shh_unsubscribe not implemented yet"); // cb(null, false);
  }

  shh_newMessageFilter(_payload, _cb) {
    throw new Error("shh_newMessageFilter not implemented yet"); // cb(null, false);
  }
  ...
  shh_deleteMessageFilter(_payload, _cb) {
    throw new Error("shh_deleteMessageFilter not implemented yet"); // cb(null, false);
  }

  shh_getFilterMessages(_payload, _cb) {
    throw new Error("shh_getFilterMessages not implemented yet"); // cb(null, false);
  }
