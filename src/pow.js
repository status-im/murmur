...
export function hexStringToDecString(s) {
  function add(_x, _y) {
    var c = 0,
      r = [];
...
export const calculatePoW = (Expiry, TTL, Topic, Data, Nonce) => {
...
export function ProofOfWork(powTarget, powTime, ttl, topic, data, expiry) {
  if (powTarget === 0) {
  ...
  outerLoop: for (let nonce = Big(0); getTime() < finish; ) {
